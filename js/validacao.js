...
const mensagensDeErro = {
   ...
   senha: {
      ...
      patternMismatch: 'A senha deve conter entre 6 e 12 caracteres, contendo pelo menos uma letra minúscula, uma maiúscula e um número. Não pode conter símbolos.'
   },
   dataNascimento: {
